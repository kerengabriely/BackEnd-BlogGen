...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.version("1.0.0")
			.license("Kerenzinha License Version 2.0")
			.licenseUrl("https://github.com/KerenGabriely")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Keren Gabriely", 
			"https://github.com/KerenGabriely", 
			"kerengabriiely@hotmail.com");
